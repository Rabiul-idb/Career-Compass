    ...
    return (
        <div className="w-11/12 mx-auto grid lg:grid-cols-2 items-center gap-10 my-24">
            ...
            <div>
                ...
                <h2 className="text-xl md:text-3xl lg:text-3xl font-bold text-slate-900 mt-3 mb-6 leading-tight">Upgrade Your Skill and <br></br>Build Your Career</h2>
               ...
               <div className='grid md:grid-cols-2 gap-7 mt-10'>
                    <div className='flex gap-6'>
                        ...
                        <div>
                            <h3 className='font-bold text-lg lg:text-xl text-black mb-4'>Master Coach</h3>
                    ...
                    <div className='flex gap-6'>
                        ...
                        <div>
                            <h3 className='font-bold text-lg lg:text-xl text-black mb-4'>Counseling Certificate</h3>
                            <p className='font-medium text-base text-gray-500'>
                                We have a team of experienced coaches who have a proven track record. 
                            </p>
                        </div>
                    ...
                    <div className='flex gap-6'>
                        ...
                        <div>
                            <h3 className='font-bold text-lg lg:text-xl text-black mb-4'>Career Development</h3>
                            <p className='font-medium text-base text-gray-500'>
                                We have a team of experienced coaches who have a proven track record. 
                            </p>
                        </div>
                    ...
                    <div className='flex gap-6'>
                        ...
                        <div>
                            <h3 className='font-bold text-lg lg:text-xl text-black mb-4'>Free Seminar</h3>
                            <p className='font-medium text-base text-gray-500'>
                                We have a team of experienced coaches who have a proven track record.
                            </p>
                        </div>
